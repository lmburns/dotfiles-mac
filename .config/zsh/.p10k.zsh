# Generated by Powerlevel10k configuration wizard on 2020-12-17 at 00:15 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%{%B%F{#f06431}%}【%{%B%F{#7e5053}%}lucas%{%B%F{#f79a32}%}@%{%B%F{#418292}%}core '
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=' %{%B%F{223}%}$'
